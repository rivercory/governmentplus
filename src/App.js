...
const App = () => {
    ...
    return (
        <div className="w-screen">
            <div className="w-full navbar border-2 m-4 rounded-full bg-base-100 md:flex hidden">
                ...
                <div className="flex-none gap-2">
                    ...
                    <label className="swap swap-rotate">
                        ...
                        <input type="checkbox" data-toggle-theme="dark,light" data-act-class="ACTIVECLASS" value="dark"/>
